    ...
    class RMBGProcessor {
        ...
        async loadModel(onProgress) {
            ...
            try {
                ...
                const { AutoModel, AutoProcessor, RawImage } = window.Transformers || {};

                if (!AutoModel || !AutoProcessor || !RawImage) {
                ...
                this.model = await AutoModel.from_pretrained('Xenova/modnet', {
                    progress_callback: (progress) => {
                        if (progress.status === 'downloading') {
                            ...
                            this.updateModelStatus(`Downloading model: ${progress.file}`, percentage);
        ...
        async processImage(img) {
            try {
                ...
                for (let i = 0; i < height * width; i++) {
                    ...
                    imageData.data[i * 4 + 3] = alpha; // Set alpha channel
                }
